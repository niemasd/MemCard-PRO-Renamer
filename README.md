...
1. Download the [`memcard_pro_renamer.py`]([memcard_pro_renamer.py](https://github.com/niemasd/MemCard-PRO-Renamer/releases/latest/download/memcard_pro_renamer.py)) script to your computer
